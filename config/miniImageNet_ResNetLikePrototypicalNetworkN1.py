...
networks = {}
net_optionsF = {'userelu': True, 'in_planes':3, 'dropout':0.5}
...
networks['feat_model'] = {'def_file': 'architectures/ResNetLike.py', 'pretrained': None, 'opt': net_optionsF, 'optim_params': net_optim_paramsF}
...
networks['classifier'] = {'def_file': 'architectures/PrototypicalNetworksHead.py', 'pretrained': None, 'opt': {'scale_cls': 1}, 'optim_params': net_optim_paramsC}
