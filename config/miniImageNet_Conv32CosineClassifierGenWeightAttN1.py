...
networks = {}
net_optionsF = {'userelu': False, 'in_planes':3, 'out_planes':[32,32,32,32], 'num_stages':4}
pretrainedF = './experiments/miniImageNet_Conv32CosineClassifier/feat_model_net_epoch*.best'
...
pretrainedC = './experiments/miniImageNet_Conv32CosineClassifier/classifier_net_epoch*.best'
net_optionsC = {'classifier_type': 'cosine', 'weight_generator_type': 'attention_based', 'nKall': nKbase, 'nFeat':32*5*5, 'scale_cls': 10, 'scale_att': 10.0}
