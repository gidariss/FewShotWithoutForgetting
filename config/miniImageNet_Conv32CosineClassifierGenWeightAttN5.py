...
net_optionsF = {
    "userelu": False,
    "in_planes": 3,
    "out_planes": [32, 32, 32, 32],
    "num_stages": 4,
}
pretrainedF = (
    "./experiments/miniImageNet_Conv32CosineClassifier/feat_model_net_epoch*.best"
)
networks["feat_model"] = {
    "def_file": "architectures/ConvNet.py",
    "pretrained": pretrainedF,
    "opt": net_optionsF,
    "optim_params": None,
}
...
pretrainedC = (
    "./experiments/miniImageNet_Conv32CosineClassifier/classifier_net_epoch*.best"
)
net_optionsC = {
...
networks["classifier"] = {
    "def_file": "architectures/ClassifierWithFewShotGenerationModule.py",
